    ...
    <div class="col-11 mt-3">
        <div class="card">
            <div class="row p-3 justify-items-center">
                <div class="col-7 mt-3" :class="{'taskCompleted':todo.done}" @dblclick="editToggle = !editToggle">
                    <input type="text" class="form-control" v-if="editToggle" v-model="todo.task" @keyup.enter="editTodo">
